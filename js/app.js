...
import { addItem, removeItem, updateItemFromRow, updateItemAmount, loadInvoice, loadLastDraft, saveDraft, saveInvoice, resetForm, updatePreview, updateTotals, updateInvoiceFromForm, updateRecurringPreview, initItemActionsDelegation } from './modules/invoice-ui.js';
...
const app = {
    ...
    async init() {
        ...
        const syncSteps = [
            ...
            ['initItemActionsDelegation', () => { if (typeof initItemActionsDelegation === 'function') initItemActionsDelegation(); }],
        ...
        // Deferred to showDashboardView() in startApp() to avoid duplicate rendering
...
app.showDashboardView = showDashboardView.bind(app);
app.switchView = switchView;
app.showInvoiceView = showInvoiceView;
app.showTemplatesView = showTemplatesView;
app.showPricingView = showPricingView;
