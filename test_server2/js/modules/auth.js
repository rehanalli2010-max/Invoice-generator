...
export function updateAuthUI() {
    ...
    const isPaid = this.user && (this.user.tier === 'pro' || this.user.tier === 'business');
    ...
    if (this.user) {
        ...
        if (tierBadge) {
            ...
            tierBadge.className = 'tier-badge' + (this.user.tier === 'pro' ? ' pro' : this.user.tier === 'business' ? ' business' : '');
        }
        if (actionCount) {
