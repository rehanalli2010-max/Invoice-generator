const fs = require('fs');
const content = fs.readFileSync('D:/CODE/Invoice generator/index.html', 'utf8');
...
if (content.includes(old)) {
    const result = content.replace(old, newContent);
    fs.writeFileSync('D:/CODE/Invoice generator/index.html', result);
    console.log('Replacement successful!');
} else {
    console.log('Old text not found!');
    const idx = content.indexOf('<section id="templates"');
    if (idx >= 0) {
